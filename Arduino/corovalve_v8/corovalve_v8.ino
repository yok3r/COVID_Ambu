...
//  Valores de Retorno
int maxup = 50; //Maxima distancia del motor al volver
int velRetorno = 200; // Velocidad de retorno del motor (menos es mas rapido)
...
float speedMin = 1000; // MIN motor Speed (More is slower)
float speedMax = 50; // MAX motor Speed (Less is more fast)
float actualSpeed = 0;
