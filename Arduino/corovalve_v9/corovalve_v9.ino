...
//  Valores de Retorno
int maxup = 400; //Maxima distancia del motor al volver
int velRetorno = 1000; // Velocidad de retorno del motor (menos es mas rapido)
...
float speedMax = 40; // MAX motor Speed (Less is faster)
float actualSpeed = 0;
...
void loop() {
  ...
  switch (state) {
    ...
    case 1: // MODO VOLUMEN
      ...
      for (int i = 0; i < (actualVolume/ciclosMoverMotor) ; i++) {
        checkPesure();
